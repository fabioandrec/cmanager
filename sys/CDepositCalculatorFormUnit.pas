...
function ShowDepositCalculator(ACanAccept: Boolean): TLoan;
...
procedure TCDepositCalculatorForm.UpdateLoanData;
var xValid: Boolean;
begin
...
procedure TCDepositCalculatorForm.ComboBoxPeriodChange(Sender: TObject);
begin
  UpdateLoanData;
end;

procedure TCDepositCalculatorForm.ComboBoxTypeChange(Sender: TObject);
begin
  UpdateLoanData;
end;

procedure TCDepositCalculatorForm.CCurrEditCashChange(Sender: TObject);
begin
  UpdateLoanData;
end;

procedure TCDepositCalculatorForm.CCurrEditTaxChange(Sender: TObject);
begin
  UpdateLoanData;
end;

procedure TCDepositCalculatorForm.CIntEditTimesChange(Sender: TObject);
begin
  UpdateLoanData;
end;

procedure TCDepositCalculatorForm.CDateTimeChanged(Sender: TObject);
begin
  UpdateLoanData;
end;
...
procedure TCDepositCalculatorForm.BitBtnOkClick(Sender: TObject);
