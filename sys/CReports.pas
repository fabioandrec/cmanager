...
begin
  ...
  with xBody do begin
    ...
    Add('<tr class="head">');
    Add('<td class="headtext" width="8%">StyczeÒ</td>');
    Add('<td class="headtext" width="8%">Luty</td>');
    Add('<td class="headtext" width="8%">Marzec</td>');
    Add('<td class="headtext" width="8%">KwiecieÒ</td>');
    Add('<td class="headtext" width="8%">Maj</td>');
    Add('<td class="headtext" width="8%">Czerwiec</td>');
    Add('<td class="headtext" width="8%">Lipiec</td>');
    Add('<td class="headtext" width="8%">SierpieÒ</td>');
    Add('<td class="headtext" width="8%">WrzesieÒ</td>');
    Add('<td class="headtext" width="8%">Paüdziernik</td>');
    Add('<td class="headtext" width="8%">Listopad</td>');
    Add('<td class="headtext" width="8%">GrudzieÒ</td>');
