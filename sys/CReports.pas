...
begin
  ...
  if not DecodeBase64Buffer(xDef.xsltText, xBufferOut) then begin
    FErrorText := 'Dane arkusza styli sπ uszkodzone i nie zostanπ wyúwietlone. Prawdopodobnie plik danych jest uszkodzony.' +
  ...
  if FErrorText = '' then begin
    ...
    if xQuery <> Nil then begin
      ...
      FErrorText := 'Podczas wykonywania zapytania tworzπcego raport wystπpi≥ b≥πd. Sprawdz definicjÍ raportu' + sLineBreak +
