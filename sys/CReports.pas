...
begin
  ...
  with xBody do begin
    ...
    for xCurCount := 0 to xCurrs.Count - 1 do begin
      Add('<table class="base">');
      Add('<tr class="head">');
      Add('<td width="20%" class="headtext">Miesiπc\Rok [' + GCurrencyCache.GetSymbol(xCurrs.Strings[xCurCount]) + ']</td>');
          ...
          for xYearCount := 1 to xYears do begin
            ...
            if xTypeCount = 1 then begin
              if (xYearCount = 1) then begin
                ...
                Add('<td width="10%" class="text">PrzychÛd</td>');
              end;
              Add('<td width="10%" class="cash">' + xInStr +'</td>');
            end else if xTypeCount = 2 then begin
              if (xYearCount = 1) then begin
                Add('<td width="10%" class="text">RozchÛd</td>');
              end;
        ...
        for xYearCount := 1 to xYears do begin
          ...
          if xTypeCount = 1 then begin
            if (xYearCount = 1) then begin
              ...
              Add('<td class="sumtext" width="10%" class="text">PrzychÛd</td>');
            end;
            Add('<td width="10%" class="sumcash">' + xInStr + '</td>');
          end else if xTypeCount = 2 then begin
            if (xYearCount = 1) then begin
              Add('<td width="10%" class="sumtext">RozchÛd</td>');
            end;
...
begin
  Result := 'PorÛwnanie lat (od ' + IntToStr(YearOf(FStartYear)) + ' do ' + IntToStr(YearOf(FEndYear)) + ')';
end;
