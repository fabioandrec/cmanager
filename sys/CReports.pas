...
begin
  ...
  with xBody do begin
    ...
    AppendGroup(xDaysBetween, xQuery, 'årednie dzienne (dla konta)', 'idAccount', xRec, xBody);
    AppendGroup(xWeeksBetween, xQuery, 'årednie tygodniowe (dla konta)', 'idAccount', xRec, xBody);
    AppendGroup(xMonthsBetween, xQuery, 'årednie miesiÍczne (dla konta)', 'idAccount', xRec, xBody);
    xQuery.Free;
    //kontahenci
    ...
    xQuery := GDataProvider.OpenSql(xSql);
    AppendGroup(xDaysBetween, xQuery, 'årednie dzienne (dla kontrahenta)', 'idCashpoint', xRec, xBody);
    AppendGroup(xWeeksBetween, xQuery, 'årednie tygodniowe (dla kontrahenta)', 'idCashpoint', xRec, xBody);
    AppendGroup(xMonthsBetween, xQuery, 'årednie miesiÍczne (dla konta)', 'idCashpoint', xRec, xBody);
    xQuery.Free;
    //kategorie
    ...
    xQuery := GDataProvider.OpenSql(xSql);
    AppendGroup(xDaysBetween, xQuery, 'årednie dzienne (dla kategorii)', 'idProduct', xRec, xBody);
    AppendGroup(xWeeksBetween, xQuery, 'årednie tygodniowe (dla kategorii)', 'idProduct', xRec, xBody);
    AppendGroup(xMonthsBetween, xQuery, 'årednie miesiÍczne (dla kategorii)', 'idProduct', xRec, xBody);
    xQuery.Free;
  end;
  Result := xBody.Text;
  xBody.Free;
